<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addClassModal{{$school->id}}">+{{ __('text.add_class') }}</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">{{ __('text.add_class') }}</h4>
            ...
            <div class="modal-body">
                <form class="new-added-form" action="{{url('admin/school/add-class')}}" method="post">
                    ...
                    <div class="form-group">
                        <label for="classRoomNumber{{$school->id}}" class="col-md-12 control-label">{{ __('text.class_group') }} (If
                            Any)</label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="classWithDepartment{{$school->id}}"
                               class="col-md-12 control-label">{{ __('text.Department') }}</label>
                        <div class="col-sm-12">
