        ...
        <div class="col-md-3">
          <div class="item-img">
            @if(!empty($user->pic_path))
              <img src="{{$user->pic_path}}" data-src="{{url($user->pic_path)}}" class="img-thumbnail" id="my-profile" alt="Profile Picture" width="100%">
            @else
              @if(strtolower($user->gender) == 'male')
                <img src="{{asset('template/img/user-default.png')}}" data-src="https://png.icons8.com/dusk/200/000000/user.png" class="img-thumbnail" width="100%">
              @else
                <img src="{{asset('template/img/user-default.png')}}" data-src="https://png.icons8.com/dusk/200/000000/user-female.png" class="img-thumbnail" width="100%">
              @endif
            @endif
          </div>
        </div>
