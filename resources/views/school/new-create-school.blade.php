                                            ...
                                            @if(\Auth::user()->role == 'master' || \Auth::user()->school_id == $school->id)
                                                <tr>
                                                    ...
                                                    @if(\Auth::user()->school_id == $school->id)
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#departmentModal">+ Create Department</button>
                                                            <!-- Modal -->
                                                        ...
                                                        <td>
                                                            <a href="#collapse{{($loop->index + 1)}}" role="button" class="btn btn-danger btn-lg" data-toggle="collapse" aria-expanded="false" aria-controls="collapse{{($loop->index + 1)}}">Manage Class, Section
                                                            </a>
                                                        </td>
                                                        {{-- <td>
                            ...
                            @foreach($schools as $school)
                                @if(\Auth::user()->role == 'admin' && \Auth::user()->school_id == $school->id)
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tr>
                                            <td>
                                                <a class="btn btn-info btn-lg" href="{{url('register/student')}}">+ Add Student</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-success btn-lg" href="{{url('register/teacher')}}">+ Add Teacher</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-secondary btn-lg" href="{{url('register/accountant')}}">+ Add Accountant</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-warning btn-lg" href="{{url('register/librarian')}}">+ Add Librarian</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tr>
                                            <td>
                                                <a class="btn btn-info btn-lg" href="{{ url('academic/notice') }}">Upload Notice</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-info btn-lg" href="{{ url('academic/event') }}">Upload Event</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
