                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6 form-group{{ $errors->has('payment_type') ? ' has-error' : '' }}">
                                        ...
                                        <select id="payment_type" class="form-control select2" name="payment_type" required>
                                            ...
                                            <option value="monthly" @if ($school->payment_type == 'monthly') selected @endif>Monthly</option>
                                            <option value="per_student" @if ($school->payment_type == 'per_student') selected @endif>Per Student</option>
                                        </select>
                                    ...
                                    <div class="mb-4 col-md-6 form-group{{ $errors->has('charge') ? ' has-error' : '' }}">
                                        ...
                                        <input id="charge" type="text" class="form-control" name="charge" value="{{$school->charge}}" required>
                                ...
                                <fieldset class="scheduler-border border border-secondary p-4">
                                    ...
                                    <div class="row">
                                        <div class="mb-4 col-md-6 form-group{{ $errors->has('is_sms_enable') ? ' has-error' : '' }}">
                                            ...
                                            <select id="is_sms_enable" class="form-control" onchange="smsChargeFieldValidation()" name="is_sms_enable" required>
                                        ...
                                        <div class="mb-4 col-md-12 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input id="email" type="text" class="form-control" name="email" value="{{$school->email}}" placeholder="Email">
                                            @if ($errors->has('email'))
                                                <span class="help-block">
                                        ...
                                        <div class="mb-4 col-md-12 form-group{{ $errors->has('due_date') ? ' has-error' : '' }}">
                                         ...
                                         <div class=" col-md-12 form-group{{ $errors->has('signup_date') ? ' has-error' : '' }}">
                                            ...
                                            <input id="signup_date" data-date-format="yyyy-mm-dd" type="text" class="form-control date" name="signup_date" value="{{$school->singup_date}}" autocomplete="off">
