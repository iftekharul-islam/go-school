    ...
    <div class="card height-auto mb-5">
        ...
        <div class="card-body">
            <form class="new-added-form" method="POST" enctype="multipart/form-data"
                  id="registerForm" action="{{ route('store.guardian') }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="false-padding-bottom-form form-group{{ $errors->has('pic_path') ? ' has-error' : '' }}">
