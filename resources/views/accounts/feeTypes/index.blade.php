            ...
            <div class="card-body">
                <div class="heading-layout1">
                    <div class="item-title">
                        ...
                        <a href="{{ route('fee-types.create') }}" class="button button--save float-right">Add Fee Types</a>
                    </div>
                </div>
                    ...
                    <table class="table display text-wrap">
                        ...
                        @foreach($feeTypes as $feeType)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('fee-types.edit', $feeType->id) }}" class="button button--save mr-3"><i class="far fa-edit"></i></a>
                                    <button class="button button--cancel" onclick="feeTypes({{ $feeType->id }})"><i class="far fa-trash-alt"></i></button>
                                    <form id="delete-form-{{ $feeType->id }}" action="{{ route('fee-types.destroy', $feeType->id) }}" method="POST">
                                        {!! method_field('delete') !!}
                                        {!! csrf_field() !!}
                                    </form>
                                </td>
