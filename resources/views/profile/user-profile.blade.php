                                ...
                                <div class="col-md-4">
                                    <div class="item-img-round mt-5">
                                        @if(!empty($user->pic_path))
                                            <img src="{{url($user->pic_path)}}" data-src="{{url($user->pic_path)}}"
                                                 class="" id="my-profile"
                                            ...
                                            <div class="col-md-6">
                                                <div class=" table-responsive border-right">
                                                    <table class="text-wrap table-borderless table ">
                                                        <tr>
                                                            <td class="text-nowrap font-medium text-dark-medium">Student
                                                                Code:
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="font-medium text-dark-medium text-nowrap">
                                                                Version:
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="font-medium text-dark-medium">E-mail /
                                                                Username:
                                                            </td>
                                            ...
                                            <div class="col-md-6">
                                                <div class=" table-responsive">
                                                    <table class="text-wrap table-borderless table ">
                                                        ...
                                                        <tr>
                                                            <td class="font-medium text-dark-medium text-nowrap">Roll
                                                                no:
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="font-medium text-dark-medium text-nowrap">Blood
                                                                Group:
                                                            </td>
