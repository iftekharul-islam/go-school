            ...
            <div class="card height-auto">
                ...
                <div class="card-body">
                    <form class="new-added-form" method="POST" action="{{url('user/config/change_password')}}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-8 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8 form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-8 form-group mg-t-8">
                                <button type="submit" class="button button--text font-weight-bold float-left"
